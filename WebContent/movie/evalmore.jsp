...
<script>
	$(function() {
		...
		$.ajax({
			url : "../movie/evalMoreLoad.jh?genre=" + genre,
			success : function(data) {
				//alert('이게나오나?22222'), 
				$(".nav-pills li[class=active]").removeClass('active'), $(this)
						.attr({
							"class" : "active"
	...
	<div class="container">
		...
		<div class="col-lg-1 sidenav">
			<ul class="nav nav-pills">
				<li class="firstTab active"><a data-toggle="tab" href="#0">
						<input class="tt" type="hidden" name="평균별점TOP영화" value="평균별점TOP영화">평균별점TOP영화
				</a></li>
				<c:forEach items="${genre}" var="genre" varStatus="status" begin="1"
					...
					<li class="othersTab"><a data-toggle="tab"
						href="#${genre.gen_no}"> <input class="tt" type="hidden"
							name="${genre.name}" value="${genre.name}">${genre.name}
					</a></li>
				</c:forEach>
