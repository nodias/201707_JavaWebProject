...
<script src="../js/tteesstt.js" type="text/javascript"></script>
<style>
.wrappedContent {
	width: 1100px;
	margin: 0 auto;
				...
				<div class="col-lg-2">
					<div class='thumbnail'>
						<a href="http://www.nate.com"> <img
							src='../boardUpload/${movie.getPoster() }' alt='ALT NAME'
					...
					<p align="center">admin님께서 좋아하는 좋아하는 ${movie.getGen_name()}장르</p>
